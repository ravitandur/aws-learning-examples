#!/usr/bin/env python3
"""
CDK Application Entry Point for Frontend Hosting Stack

Deploys React frontend infrastructure (S3 + CloudFront) following
the project's multi-environment architecture pattern.
"""

import os
import json
import aws_cdk as cdk
from cdk_stack.frontend_hosting_stack import FrontendHostingStack
...
stack_name = f"ql-algo-trading-{environment}-frontend-hosting-stack"
...
FrontendHostingStack(
    ...
    description=f"Quantleap Analytics Frontend Hosting - {environment.title()} Environment"
)
