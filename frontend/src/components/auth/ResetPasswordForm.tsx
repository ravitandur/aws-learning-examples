    ...
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-8 w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="mb-4">
          ...
          {fieldErrors.verificationCode && (
            <p className="mt-1 text-xs text-red-600 dark:text-red-400">{fieldErrors.verificationCode}</p>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`block w-full pl-10 pr-12 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 ${
