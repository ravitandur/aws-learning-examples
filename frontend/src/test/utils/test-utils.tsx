  ...
  legs: [
    {
      ...
      premiumOperator: 'CP_EQUAL' as const,
      premiumValue: 0,
      straddlePremiumOperator: 'CP_EQUAL' as const,
      straddlePremiumPercentage: 5,
      stopLoss: { enabled: false, type: 'POINTS' as const, value: 0 },
      targetProfit: { enabled: false, type: 'POINTS' as const, value: 0 },
      trailingStopLoss: { enabled: false, type: 'POINTS' as const, instrumentMoveValue: 0, stopLossMoveValue: 0 },
      waitAndTrade: { enabled: false, type: 'POINTS' as const, value: 0 },
